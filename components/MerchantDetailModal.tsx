    ...
    const drawerContent = (
        <div className="fixed inset-0 z-[9999] overflow-hidden">
            ...
            <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
                <div 
                    className={`w-screen max-w-xl md:max-w-2xl h-screen bg-white dark:bg-dark-card backdrop-blur-2xl dark:shadow-[inset_1px_0_0_0_rgba(255,255,255,0.1)] text-light-text dark:text-dark-text shadow-2xl border-l border-black/10 dark:border-white/10 flex flex-col justify-between transform transition-transform duration-300 ease-out ${
                        isVisible ? 'translate-x-0' : 'translate-x-full'
                    }`}
                    onClick={(e) => e.stopPropagation()}
                >
                    {/* 1. Header Section */}
                    <div className="shrink-0 border-b border-black/5 dark:border-white/5 bg-gradient-to-r from-primary-500/5 to-transparent">
                        {/* Top Action Ribbon */}
                            ...
                            <div className="flex items-center gap-2">
                                {canRefreshFromBrandfetch && (
                                    <button
                                        ...
                                        className="w-9 h-9 rounded-xl text-light-text-secondary dark:text-dark-text-secondary hover:bg-black/5 dark:hover:bg-white/5 transition-all flex items-center justify-center"
                    ...
                    <div className="shrink-0 p-6 border-t border-black/5 dark:border-white/5 bg-white/90 dark:bg-dark-card/80 backdrop-blur-md flex items-center justify-between gap-3">
                        <button
                            type="button"
                            onClick={() => {
                                setCategory('');
                            ...
                            className="text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 hover:text-rose-500 transition-colors cursor-pointer"
                        >
                            Reset Fields
                        </button>
