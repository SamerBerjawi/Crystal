    ...
    const drawerContent = (
        <div className="fixed inset-0 z-[9999] overflow-hidden">
            ...
            <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
                <div 
                    className={`w-screen max-w-xl md:max-w-2xl h-screen bg-light-card dark:bg-dark-card text-light-text dark:text-dark-text shadow-2xl border-l border-black/10 dark:border-white/10 flex flex-col justify-between transform transition-transform duration-300 ease-out ${
                ...
                >
                    ...
                    <div className="shrink-0 p-6 border-t border-black/5 dark:border-white/5 bg-light-card/80 dark:bg-dark-card/80 backdrop-blur-md flex items-center justify-between gap-3">
                        <button
                            type="button"
                            onClick={() => {
                                setCategory('');
