  ...
  return (
    <div className="space-y-6 md:space-y-10 animate-fade-in-up pb-10">
      ...
      <MobileAccountHeader
        ...
        primaryAction={{ label: 'Log Contribution', icon: 'PlusCircle', onClick: onAddTransaction }}
          ...
          <div className="flex items-center gap-6">
              ...
              <div>
                  ...
                  <h1 className="text-4xl font-bold text-light-text dark:text-dark-text tracking-tighter flex items-center gap-3">
                      {account.name}
                      <Icon name={account.icon || 'assured_workload'} className="text-light-text-secondary/20 dark:text-dark-text-secondary/20 font-light" />
                  </h1>
              </div>
          </div>
                         ...
                         <ResponsiveContainer width="100%" height="100%">
                            <ComposedChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                                ...
                                <Tooltip 
                                    ...
                                    itemStyle={{ color: 'var(--tooltip-text, #0f172a)', fontSize: '18px', fontWeight: '900' }}
                                    labelStyle={{ color: 'var(--tooltip-text-secondary, #64748b)', fontWeight: 'bold', marginBottom: '8px',  letterSpacing: '0.1em', fontSize: '10px' }}
