                            ...
                            <div>
                                {mode === 'single' ? (
                                    ...
                                    <button 
                                        type="button" 
                                        onClick={() => setBulkData('')} 
                                        className="h-12 px-4 text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white rounded-xl transition-all"
                                    >
                                        Clear All
                                    </button>
                                )}
