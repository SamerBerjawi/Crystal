...
const WidgetWrapper: React.FC<WidgetWrapperProps> = ({ 
  ...
  return (
    ...
    >
      <Card className={`flex flex-col h-full transition-all duration-200 ${isCompact ? '!p-4' : '!p-5'} ${isEditMode ? 'border-dashed border-primary-500/50 ring-2 ring-primary-500/20' : ''}`}>
