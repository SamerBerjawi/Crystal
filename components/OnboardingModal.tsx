...
import { FinauraLogo, BTN_PRIMARY_STYLE, BTN_SECONDARY_STYLE, INPUT_BASE_STYLE, SELECT_WRAPPER_STYLE, SELECT_ARROW_STYLE, CURRENCIES, ACCOUNT_TYPE_STYLES, ALL_ACCOUNT_TYPES, CURRENCY_OPTIONS } from '../constants';
      ...
      case 6:
         return (
          <div className="text-center">
            ...
            <p className="text-lg text-light-text-secondary dark:text-dark-text-secondary max-w-md mx-auto">
              You can now explore your personalized Finaura dashboard.
            </p>
          </div>
        );
      default: return null;
    ...
    <div className="fixed inset-0 bg-light-bg dark:bg-dark-bg z-[100] flex flex-col p-6 transition-opacity duration-300">
        <header className="flex-shrink-0 flex items-center justify-between">
            <div className="flex items-center gap-3">
                <FinauraLogo theme="system" />
                <span className="text-xl font-bold">Finaura Setup</span>
            </div>
            {(step === 1 || step === 6) && (
