    ...
    <header className={`flex flex-col md:flex-row gap-4 md:items-center md:justify-between ${className}`}>
      <div className="flex flex-col gap-1">
        ...
        <div className="space-y-0.5">
          <h1 className="text-2xl font-bold text-light-text dark:text-dark-text tracking-tight leading-tight">{title}</h1>
          <p className="text-xs font-medium text-light-text-secondary dark:text-dark-text-secondary max-w-3xl opacity-70 leading-relaxed">{subtitle}</p>
        </div>
      </div>
