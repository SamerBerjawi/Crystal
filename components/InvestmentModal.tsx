          ...
          <div className="shrink-0 border-b border-black/5 dark:border-white/5 bg-gray-50/70 dark:bg-white/[0.02]">
            ...
            <div className="flex items-center justify-between px-5 sm:px-6 pt-4 pb-2">
              <div className="flex items-center gap-2 flex-wrap">
                <span className={`inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider px-2.5 py-1 rounded-full border ${
                  mode === 'trade' 
                    ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-500/10 border-indigo-500/20'
                    : 'text-amber-600 dark:text-amber-400 bg-amber-500/10 border-amber-500/20'
                }`}>
                  <Icon name={mode === 'trade' ? 'trending_up' : 'verified'} className="text-xs" />
                  {mode === 'trade' 
                ...
                {mode === 'trade' && (
                  <span className={`inline-flex items-center gap-1 text-2xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-md ${
                    tradeType === 'buy' 
          ...
          <div className="shrink-0 p-4 sm:p-5 border-t border-black/10 dark:border-white/10 bg-white/95 dark:bg-[#12141a]/95 backdrop-blur-md flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                className={`${BTN_PRIMARY_STYLE} !py-2 !px-6 !text-xs flex items-center gap-1.5 shadow-md ${
