            ...
            <div className="flex flex-col h-full">
                    ...
                    <div className="flex justify-between items-center gap-4">
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-light-text-secondary dark:text-dark-text-secondary">Net Worth</span>
                            </div>
                ...
                <div className="grid grid-cols-3 divide-x divide-black/5 dark:divide-white/5 border-b border-black/5 dark:border-white/5 flex-grow min-h-[100px]">
                     ...
                     <div className="p-4 flex flex-col justify-center">
                         <span className="text-[9px] font-black uppercase tracking-[0.2em] text-light-text-secondary dark:text-dark-text-secondary mb-1.5 block">Net Flow</span>
                         ...
                         <div className="mt-2 flex items-center gap-1.5">
                             ...
                             <span className="text-[8px] font-bold uppercase tracking-widest opacity-40">{isPositiveNet ? 'Surplus' : 'Deficit'}</span>
                         </div>
                     </div>
                     ...
                     <div className="p-4 flex flex-col justify-center group/stat hover:bg-emerald-500/[0.02] transition-colors relative overflow-hidden">
                        <div className="flex justify-between items-center mb-1.5 relative z-10">
                             ...
                             {incomeChange && (
                                <span className={`text-[9px] font-black ${incomeChange.startsWith('+') ? 'text-emerald-500' : 'text-rose-500'}`}>
                                    {incomeChange}
                                </span>
                             )}
                        </div>
                     ...
                     <div className="p-4 flex flex-col justify-center group/stat hover:bg-rose-500/[0.02] transition-colors relative overflow-hidden">
                        <div className="flex justify-between items-center mb-1.5 relative z-10">
                             ...
                             {expenseChange && (
                                <span className={`text-[9px] font-black ${expenseChange.startsWith('+') ? 'text-rose-500' : 'text-emerald-500'}`}>
                                    {expenseChange}
                                </span>
                             )}
                        </div>
                ...
                <div className="px-6 py-4 bg-gray-50/50 dark:bg-white/[0.01]">
                    <div className="flex justify-between items-center mb-2">
                         <div className="flex items-center gap-2">
                             <span className="text-[9px] font-black text-light-text-secondary dark:text-dark-text-secondary uppercase tracking-[0.2em]">Burn Intensity</span>
                             <div className="w-1 h-1 rounded-full bg-light-text-secondary/20"></div>
                             <span className={`text-[9px] font-black ${flowIntensity > 100 ? 'text-rose-500' : 'text-primary-500'}`}>{flowIntensity.toFixed(0)}%</span>
                         </div>
