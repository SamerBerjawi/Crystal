...
const BentoCard = ({
  ...
  return (
    <div
      key={name}
      className={cn(
        "group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-2xl glass-section shadow-card",
        "text-light-text dark:text-dark-text transform-gpu",
        className
      )}
      {...props}
    >
