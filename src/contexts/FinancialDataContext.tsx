...
interface FinancialDataProviderProps {
  ...
  memberships: MembershipsContextValue;
}
...
export const FinancialDataProvider: React.FC<FinancialDataProviderProps> = ({
  ...
  const memoMemberships = useMemo(() => memberships, [memberships]);
                ...
                <BudgetsContext.Provider value={memoBudgets}>
                  <GoalsContext.Provider value={memoGoals}>
                    <ScheduleContext.Provider value={memoSchedule}>
                      <MembershipsContext.Provider value={memoMemberships}>
                        {children}
...
export const useMembershipsContext = () => {
  ...
  if (!context) throw new Error('useMembershipsContext must be used within FinancialDataProvider');
  return context;
};
