...
export function PieChart({
  ...
  return (
    <div
      className={cn("relative aspect-square w-full h-full flex items-center justify-center", className)}
      ref={containerRef}
    >
      <ParentSize debounceTime={10} className="w-full h-full flex items-center justify-center">
        {({ width, height }) => (
          <PieChartInner
            containerRef={containerRef}
            cornerRadius={cornerRadius}
