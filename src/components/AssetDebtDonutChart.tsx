    ...
    <div className="h-full flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
                <div className="flex items-center gap-2">
                    ...
                    <div className="text-sm">
                        ...
                        <p className="font-semibold privacy-blur">{formatCurrency(assets, 'EUR')}</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                     ...
                     <div className="text-sm">
                        ...
                        <p className="font-semibold privacy-blur">{formatCurrency(Math.abs(debt), 'EUR')}</p>
                    </div>
                </div>
            </div>
        </div>
      <div className="flex-grow relative -mt-4" style={{ width: '100%', minHeight: '180px' }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            ...
            <span className="text-2xl lg:text-3xl font-bold text-light-text dark:text-dark-text text-center privacy-blur">{formatCurrency(netWorth, 'EUR')}</span>
        </div>
      </div>
    </div>
  );
