        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border border-black/5 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-2xl font-bold text-light-text dark:text-dark-text privacy-blur">{formatCurrency(totalAssets, 'EUR')}</p>
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border border-black/5 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-2xl font-bold text-light-text dark:text-dark-text privacy-blur">{formatCurrency(totalDebt, 'EUR')}</p>
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border border-black/5 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-2xl font-bold text-light-text dark:text-dark-text privacy-blur">{formatCurrency(liquidCash, 'EUR')}</p>
                    ...
                    <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border border-black/5 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className={`text-2xl font-bold privacy-blur ${netChange30d >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
