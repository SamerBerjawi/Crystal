...
try {
    ...
    const res = validateFinancialDataPayload(validBody);
...
try {
    ...
    const res = validateFinancialDataPayload(corruptedBody);
...
try {
    ...
    const res = validateFinancialDataPayload(partialBody);
...
try {
    const res = validateFinancialDataPayload(null);
