...
try {
    ...
    const encrypted = (0, crypto_1.encryptSecret)(rawKey);
...
try {
    ...
    const sanitized = (0, crypto_1.sanitizeConnection)(rawConnection);
    ...
    const decrypted = (0, crypto_1.decryptSecret)(sanitized.encryptedClientCertificate);
