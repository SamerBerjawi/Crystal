  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <header>
        ...
        <div className="mt-4">
            <p className="text-light-text-secondary dark:text-dark-text-secondary mt-1">Configure and learn about the AI-powered features in Crystal.</p>
        </div>
      </header>
      ...
      <Card>
        ...
        <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
          Crystal uses Google's powerful Gemini family of models to provide AI-powered features like the chat assistant and smart financial planning. These features help you analyze your finances and get insights by asking questions in natural language.
        </p>
      </Card>
