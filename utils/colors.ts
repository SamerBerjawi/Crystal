...
export const getIconColorClasses = (color: string): string => {
  switch (color) {
    ...
    case 'gold': return 'text-amber-500 dark:text-yellow-400 font-bold';
    ...
    case 'gray': return 'text-neutral-600 dark:text-neutral-400';
    case 'sky': return 'text-sky-600 dark:text-sky-400';
    case 'pink': return 'text-pink-600 dark:text-pink-400';
    case 'neutral': return 'text-neutral-900 dark:text-white font-semibold';
...
export const getBgClasses = (color: string): string => {
  switch (color) {
    ...
    case 'gold': return 'bg-amber-500/15 dark:bg-amber-400/20';
    ...
    case 'neutral': return 'bg-neutral-500/10 dark:bg-white/10';
...
export const getGlowClasses = (color: string): string => {
  switch (color) {
    ...
    case 'gold': return 'bg-amber-400 shadow-[0_0_30px_rgba(251,191,36,0.9)]';
    ...
    case 'neutral': return 'bg-neutral-400 dark:bg-white shadow-[0_0_20px_rgba(255,255,255,0.4)]';
